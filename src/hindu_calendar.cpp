...
PanchangaData HinduCalendar::calculatePanchanga(const BirthData& birthData) const {
    ...
    return calculatePanchanga(birthData.getJulianDay(), birthData.latitude, birthData.longitude, birthData.timezone);
}

// 3-parameter overload for backward compatibility
PanchangaData HinduCalendar::calculatePanchanga(double julianDay, double latitude, double longitude) const {
    return calculatePanchanga(julianDay, latitude, longitude, 0.0);
}

PanchangaData HinduCalendar::calculatePanchanga(double julianDay, double latitude, double longitude, double timezone) const {
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchHinduCalendar(const SearchCriteria& criteria, double latitude, double longitude) const {
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchByTithi(int tithi, const std::string& startDate, const std::string& endDate, double latitude, double longitude, bool exactMatch) const {
...
// Search by weekday
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchByWeekday(int weekday, const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
// Search by month
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchByMonth(int month, const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
// Search by year
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchByYear(int year, const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchEkadashiAndPurnima(const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchPurnimaOrAmavasya(const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
    criteria.searchPurnima = true;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchByNakshatra(int nakshatra, const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchMultiCriteria(const SearchCriteria& criteria, LogicMode logicMode, const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchByJulianDay(double julianDay, const std::string& startDate, const std::string& endDate, double latitude, double longitude, double tolerance) const {
    SearchCriteria criteria;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchByJulianDayRange(double jdStart, double jdEnd, const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchByVarnaDay(const std::string& varnaType, const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchByVarnaTithi(const std::string& varnaType, const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchByVarnaNakshatra(const std::string& varnaType, const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchBrahminDays(const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchKshatriyaDays(const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchVaishyaDays(const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchShudradays(const std::string& startDate, const std::string& endDate, double latitude, double longitude) const {
    SearchCriteria criteria;
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchSankranti(const std::string& startDate,
...
std::vector<Astro::HinduCalendar::SearchResult> Astro::HinduCalendar::searchSpecificSankranti(Rashi rashi,
